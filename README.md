...
- **[使用文档 (中文)](./项目文档/使用文档.md)**：包含详细的系统介绍、快速启动指南及常见问题。
- **项目模块详解 (根目录 `/项目文档`)**:
  - **[前端技术文档](./项目文档/前端文档.md)**：架构设计、权限控制、组件说明。
  - **[后端技术文档](./项目文档/后端文档.md)**：API 接口、事务处理、逻辑下沉。
  - **[数据库技术文档](./项目文档/数据库文档.md)**：触发器、存储过程、范式分析。
- **[数据库设计报告](./database/normalization_report.md)**：详细的范式分析 (BCNF)、E-R 图转化。
